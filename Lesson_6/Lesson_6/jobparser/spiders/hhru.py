...
class HhruSpider(scrapy.Spider):
    ...
    start_urls = [
        'https://engels.hh.ru/search/vacancy?text=Python&area=1&salary=&currency_code=RUR&experience=doesNotMatter&order_by=relevance&search_period=0&items_on_page=20&no_magic=true&L_save_area=true',
